...
final class PeerImpl implements Peer {
    ...
    public int getWeight() {
        ...
        return (int)(adjustedWeight * (hallmarkBalance / Constants.ONE_BND) / Constants.MAX_BALANCE_BND);
    }
    ...
    boolean analyzeHallmark(final String hallmarkString) {
        ...
        try {
            ...
            for (PeerImpl peer : groupedPeers) {
                peer.adjustedWeight = Constants.MAX_BALANCE_BND * peer.getHallmarkWeight(mostRecentDate) / totalWeight;
